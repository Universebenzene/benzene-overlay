...
SRC_URI+=" test? (
		...
		https://github.com/mxmlnkn/mfusepy/raw/refs/tags/v${PV}/examples/readdir_returning_offsets.py -> ${P}-t-readdir_returning_offsets.py
		https://github.com/mxmlnkn/mfusepy/raw/refs/tags/v${PV}/examples/readdir_with_offset.py -> ${P}-t-readdir_with_offset.py
	)
"
