...
dev-python/astropy-iers-data   | 0.2025.6.30.0.39.40                                  | Required by astropy>=6.0.0
...
dev-python/specutils           | 1.20.3; 2.0.0                                        | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
