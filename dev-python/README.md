...
dev-python/astropy-iers-data   | 0.2026.6.22.1.23.34                                  | Required by astropy>=6.0.0
...
dev-python/ginga               | 6.0.0                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
