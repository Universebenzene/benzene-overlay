...
dev-python/astropy-iers-data   | 0.2023.12.4.0.30.20                                 | Required by astropy>=6.0.0
...
dev-python/astropy-healpix     | 0.5; 1.0.1                                          | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/glueviz             | 1.2.0-r1 (glue-core: 1.17.0; glue-qt: 0.3.0)        | Meta package, core package and qt package versions are all shown.
...
dev-python/h5pyd               | 0.12.2; 0.16.0; 0.17.0                              |
...
dev-python/sunpy               | 5.1.0                                               | Testing and doc building are really hard to run, so not supported right now.
