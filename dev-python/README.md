...
dev-python/astropy-iers-data   | 0.2026.2.9.0.50.33                                   | Required by astropy>=6.0.0
...
dev-python/asdf-astropy        | 0.2.1; 0.9.0                                         | Dependencies are also in this overlay but not listed in this table. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/echo                | 0.12.0                                               | Glueviz releated.
...
dev-python/glueviz             | 1.4.0 (glue-core: 1.17.1, 1.24.1; glue-qt: 0.4.1)    | Meta package. Core package and qt package versions are all shown.
dev-python/glue-vispy-viewers  | 1.1.0; 1.3.0                                         |
dev-python/gwcs                | 1.0.2                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
