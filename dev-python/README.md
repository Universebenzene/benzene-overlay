...
------------ | :---------------: | ----------------------
dev-python/astropy             | 5.0.8; 5.3.4; 6.0.1; 6.1.7; 8.0.1                    | Versions below 5.3 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/astropy#note-for-astropy) for more details. wcslib>=8.1 is included in this overlay for astropy>=6.0.0
dev-python/astroalign          | 2.6.2                                                |
dev-python/astropy-iers-data   | 0.2026.9.14.0.56.43                                  | Required by astropy>=6.0.0
...
dev-python/aplpy               | 2.2.1                                                | Versions below 2.1.0 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/aplpy#note-for-aplpy) for more details. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/asdf                | 2.10.1; 2.13.0; 2.15.0; 2.15.2; 4.5.0; 5.4.0         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
dev-python/asdf-astropy        | 0.2.1; 0.11.0                                        | Dependencies are also in this overlay but not listed in this table. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/astlib              | 0.11.10-r1; 0.13.2                                   | astLib WCS library for ginga
dev-python/astrodendro         | 0.3.0; (live)                                        |
dev-python/astroml             | 0.4.1; 1.0.2\_p1                                     |
dev-python/astropy-healpix     | 2.0.1                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/astroquery          | 0.3.10; 0.4.11                                       | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/astroscrappy        | 1.3.0                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/cdflib              | 0.4.9; 1.3.6; 1.3.12                                 | SunPy releated.
...
dev-python/h5pyd               | 0.12.2; 0.18.0; 0.23.0; 2.0.0                        |
...
dev-python/jplephem            | 2.24                                                 |
dev-python/jsonschema          | 3.2.0-r1; 4.9.1                                      | For old versions of dev-python/asdf
dev-python/mocpy               | 0.20.0                                               | Dependency cdshealpix are also in this overlay but not listed in this table
dev-python/mpl-animator        | 1.2.4                                                |
dev-python/mpl-scatter-density | 0.8                                                  | Glueviz releated.
dev-python/naima               | 0.10.4                                               |
dev-python/ndcube              | 2.2.0; 2.4.1                                         | SunPy releated. Dependency of specutils.
dev-python/photutils           | 1.9.0; 1.12.0; 3.0.0                                 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
dev-python/pvextractor         | 0.4                                                  | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
dev-python/pyavm               | 0.9.9                                                |
...
dev-python/pyvo                | 1.2.1; 1.9.1                                         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/radio-beam          | 0.3.10                                               | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/regions             | 0.12                                                 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/reproject           | 0.12.0; 0.21.0                                       | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/sep                 | 1.4.0                                                |
dev-python/sep-pjw             | 1.3.8                                                |
dev-python/sgp4                | 2.27                                                 |
...
dev-python/skyfield            | 1.55                                                 |
dev-python/spectral-cube       | 0.6.7                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
