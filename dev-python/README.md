...
dev-python/astropy-iers-data   | 0.2026.7.20.15.31.18                                 | Required by astropy>=6.0.0
...
dev-python/asdf                | 2.10.1; 2.13.0; 2.15.0; 2.15.2; 4.5.0; 5.3.1         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/astropy-healpix     | 0.5; 1.1.3                                           | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/ginga               | 7.0.0                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
...
dev-python/healpy              | 1.16.6; 1.19.0                                       |
