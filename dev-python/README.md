...
------------ | :---------------: | ----------------------
dev-python/astropy             | 5.0.6; 5.1.1; 5.2.2                  | Versions below 5.0.2 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/astropy#note-for-astropy) for more details.
...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/glueviz             | 1.2.0 (glue-core: 1.9.1)             | Both meta package and core package versions are shown.
dev-python/glue-vispy-viewers  | 1.0.7                                |
...
dev-python/h5pyd               | 0.12.2; 0.13.1; 0.14.0               |
...
dev-python/photutils           | 1.7.0                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
...
dev-python/pyerfa              | 1.7.2; 2.0.0.3                       | Fixed test phase. One of the deps of `astropy`. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
...
dev-python/sunpy               | 4.1.5                                | Testing and doc building are really hard to run, so not supported right now.
