...
dev-python/astropy-iers-data   | 0.2024.3.18.0.29.47                                 | Required by astropy>=6.0.0
...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0; 2.15.2; 3.1.0 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
dev-python/asdf-astropy        | 0.2.1; 0.6.0                                        | Dependencies are also in this overlay but not list in this table. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/cdflib              | 0.4.9; 1.1.1; 1.2.6                                 | SunPy releated. 1.1.1 remained as some tests failed in 1.1.2 and later
...
dev-python/skyfield            | 1.45; 1.46; 1.48                                    |
