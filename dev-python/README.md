...
dev-python/astropy-iers-data   | 0.2024.11.25.0.34.48                                 | Required by astropy>=6.0.0
...
dev-python/glueviz             | 1.3.0 (glue-core: 1.17.1, 1.21.1; glue-qt: 0.3.1)    | Meta package, core package and qt package versions are all shown.
...
dev-python/sunpy               | 5.1.5; 6.0.3                                         | Doc building is really hard to run, so not supported right now.
