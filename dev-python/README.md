...
dev-python/astropy-iers-data   | 0.2024.12.16.0.35.48                                 | Required by astropy>=6.0.0
...
dev-python/gwcs                | 0.17.1; 0.22.0                                       | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
