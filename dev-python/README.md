...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0; 2.15.2 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/astlib              | 0.11.3; 0.11.9                               | astLib WCS library for ginga
...
dev-python/cdflib              | 0.4.9; 1.1.1; 1.2.2                          | SunPy releated. 1.1.1 remained as some tests failed in 1.1.2 and later
...
dev-python/pyerfa              | 1.7.2; 2.0.1                                 | Fixed test phase. One of the deps of `astropy`. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
