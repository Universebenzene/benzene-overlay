...
dev-python/astropy-iers-data   | 0.2026.3.16.0.53.33                                  | Required by astropy>=6.0.0
...
dev-python/asdf                | 2.10.1; 2.13.0; 2.15.0; 2.15.2; 4.5.0; 5.1.0         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
dev-python/asdf-astropy        | 0.2.1; 0.10.0                                        | Dependencies are also in this overlay but not listed in this table. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
