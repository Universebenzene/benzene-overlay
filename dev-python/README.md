...
------------ | :---------------: | ----------------------
dev-python/astropy             | 5.0.6; 5.2.2; 5.3.1                  | Versions below 5.0.2 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/astropy#note-for-astropy) for more details.
...
dev-python/cdflib              | 0.4.9; 1.1.0                         | SunPy releated.
...
dev-python/glueviz             | 1.2.0 (glue-core: 1.12.0)             | Both meta package and core package versions are shown.
...
dev-python/h5pyd               | 0.12.2; 0.14.1; 0.15.1               |
dev-python/healpy              | 1.16.3                               |
...
dev-python/ndcube              | 2.1.3                                | SunPy releated. Dependency of specutils.
...
dev-python/spectral-cube       | 0.6.2                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
