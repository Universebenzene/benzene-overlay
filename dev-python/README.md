...
dev-python/astropy-iers-data   | 0.2025.4.28.0.37.27                                  | Required by astropy>=6.0.0
...
dev-python/glueviz             | 1.4.0 (glue-core: 1.17.1, 1.22.1; glue-qt: 0.3.3)    | Meta package, core package and qt package versions are all shown.
...
dev-python/pyvo                | 1.2.1; 1.6.2                                         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/specutils           | 1.1.1; 1.20.0                                        | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
