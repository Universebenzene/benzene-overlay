...
------------ | :---------------: | ----------------------
dev-python/astropy             | $.3.4; 6.0.1; 6.1.7; 5.0.8                           | Versions below 5.3 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/astropy#note-for-astropy) for more details. wcslib>=8.1 is included in this overlay for astropy>=6.0.0
dev-python/astroalign          | 2.6.1                                                |
dev-python/astropy-iers-data   | 0.2025.1.20.0.32.27                                  | Required by astropy>=6.0.0
...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0; 2.15.2; 4.0.0  | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
dev-python/asdf-astropy        | 0.2.1; 0.7.0                                         | Dependencies are also in this overlay but not listed in this table. `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/astroquery          | 0.3.10; 0.4.8                                        | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/cdflib              | 0.4.9; 1.3.3                                         | SunPy releated.
...
dev-python/ginga               | 5.2.0                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
dev-python/glueviz             | 1.4.0 (glue-core: 1.17.1, 1.21.1; glue-qt: 0.3.1)    | Meta package, core package and qt package versions are all shown.
dev-python/glue-vispy-viewers  | 1.1.0; 1.2.2                                         |
dev-python/gwcs                | 0.17.1; 0.22.1                                       | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
dev-python/h5netcdf            | 1.4.1                                                |
...
dev-python/ndcube              | 2.2.0; 2.3.0                                         | SunPy releated. Dependency of specutils.
dev-python/photutils           | 1.9.0; 1.12.0; 2.1.0                                 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
...
dev-python/pyvo                | 1.2.1; 1.6                                           | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
...
dev-python/sunpy               | 5.1.5; 6.0.4                                         | Doc building is really hard to run, so not supported right now.
