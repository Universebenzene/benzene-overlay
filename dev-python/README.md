...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0; 2.15.2; 3.0.0 | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/glueviz             | 1.2.0-r1 (glue-core: 1.14.0; glue-qt: 0.2.0)        | Meta package, core package and qt package versions are all shown.
