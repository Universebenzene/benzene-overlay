...
dev-python/ginga               | 5.5.1                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
...
dev-python/starlink-pyast      | 4.0.0                                                | Starlink WCS library for ginga
