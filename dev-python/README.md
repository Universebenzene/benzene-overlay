...
------------ | :---------------: | ----------------------
dev-python/astropy             | 5.0.8; 5.3.4; 6.0.1; 6.1.7; 7.2.0                    | Versions below 5.3 are included but masked. See [here](https://github.com/Universebenzene/benzene-overlay/tree/master/dev-python/astropy#note-for-astropy) for more details. wcslib>=8.1 is included in this overlay for astropy>=6.0.0
dev-python/astroalign          | 2.6.2                                                |
dev-python/astropy-iers-data   | 0.2026.4.20.0.58.15                                  | Required by astropy>=6.0.0
...
dev-python/pytest-asdf-plugin  | 0.1.2                                                |
...
dev-python/asdf                | 2.10.1; 2.13.0; 2.15.0; 2.15.2; 4.5.0; 5.2.0         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/cdflib              | 0.4.9; 1.3.6; 1.3.9                                  | SunPy releated.
...
dev-python/glueviz             | 1.4.0 (glue-core: 1.17.1, 1.25.0; glue-qt: 0.4.2)    | Meta package. Core package and qt package versions are all shown.
dev-python/glue-vispy-viewers  | 1.1.0; 1.3.0                                         |
...
dev-python/specutils           | 1.20.3; 2.3.0                                        | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building
dev-python/specreduce          | 1.7.0; 1.8.0                                         | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Some images cannot be plotted if intersphinx is disabled.
dev-python/spherical-geometry  | 1.4.0                                                |
dev-python/starlink-pyast      | 4.0.1                                                | Starlink WCS library for ginga
dev-python/sunpy               | 5.1.5; 6.1.1; 7.1.0                                  | Doc building is really hard to run, so not supported right now.
