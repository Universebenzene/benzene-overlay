...
dev-python/astropy-iers-data   | 0.2026.8.18.14.22.31                                 | Required by astropy>=6.0.0
...
dev-python/ginga               | 7.3.0                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
