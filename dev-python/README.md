...
dev-python/astropy-iers-data   | 0.2024.7.15.0.31.42                                  | Required by astropy>=6.0.0
...
dev-python/asdf                | 2.7.2; 2.9.2; 2.10.1; 2.13.0; 2.15.0; 2.15.2; 3.3.0  | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building. Doc building should only be enabled for re-merge to prevent circular depenencies.
...
dev-python/glue-vispy-viewers  | 1.1.0; 1.2.1                                         |
...
dev-python/sunpy               | 5.1.5                                                | Doc building is really hard to run, so not supported right now.
