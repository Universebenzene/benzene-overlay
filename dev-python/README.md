...
dev-python/astropy-iers-data   | 0.2024.4.15.2.45.49                                  | Required by astropy>=6.0.0
...
dev-python/casa-formats-io     | 0.2.3                                                |
...
dev-python/fast-histogram      | 0.13                                                 | Glueviz releated.
dev-python/ginga               | 5.0.1                                                | `network-sandbox` FEATURE will be disabled if you enable intersphinx linking for doc building.
dev-python/glueviz             | 1.2.0-r1 (glue-core: 1.17.1, 1.19.0; glue-qt: 0.3.1) | Meta package, core package and qt package versions are all shown.
