...
dev-python/python-jenkins                                                            | 1.8.0; (live)                                                                           | Dependency multi\_key\_dict is also included. Live version is recommendend, as 1.8.0 requires old `requests`
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.1.3](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.1.3.ebuild)                | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh)
