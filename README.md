...
[x11-plugins/purple-oicq](https://github.com/axon-oicq/purple-oicq)                  | [1.0.2](https://github.com/Universebenzene/benzene-overlay/blob/master/x11-plugins/purple-oicq/purple-oicq-1.0.2.ebuild); (live)         | OICQ plugin (Tencent QQ support) for Pidgin/libpurple.
