...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.9.20](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.9.20.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support. Might not work due to [a bug in OICQ](https://github.com/takayama-lily/oicq/issues/408)
...
dev-python/distributed           | 2023.5.1; 2023.6.0; 2023.6.1                      | Optional for arviz and spectral-cube
