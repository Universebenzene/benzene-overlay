...
dev-python/textual                 | 0.53.1                                            | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/sunpy-sphinx-theme           | 1.2.42; 2.0.2; 2.0.4 |
