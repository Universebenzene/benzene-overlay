...
app-i18n/fcitx-table-other                                                           | 0.2.4-r1                                                                                                              | Not included in official portage or other overlays. Modified icon name in order to be enable to install along with fcitx:5.
