...
dev-python/textual                 | 7.2.0                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/jupytext                     | 1.18.1                          | Build with wheel source to include Jupyter Lab Extenstion
