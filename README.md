...
[app-pda/i4tools](https://www.i4.cn/pro_pc.html)                                     | [3.08.002](https://github.com/Universebenzene/benzene-overlay/blob/master/app-pda/i4tools/i4tools-3.08.002.ebuild)                                         | 爱思助手 <!--`net-nds/openldap-compat` is included in this overlay for fixing the `libldap_r-2.4.so.2` issue-->
