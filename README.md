...
dev-python/PyQt5                                                                     | 5.15.9-r1; 5.15.10-r1                                                                              | Add `webkit` USE flag (dropped by official portage) to get **youdao-dict** in this overlay work
dev-python/pytest-cython                                                             | 0.2.1                                                                                              |
dev-python/pytest-socket                                                             | 0.5.0; 0.6.0                                                                                       |
dev-python/api4jenkins                                                               | 2.0.1                                                                                              | Test dependency respx is also included but not listed here
dev-python/python-jenkins                                                            | 1.8.1; (live)                                                                                      | Dependency multi\_key\_dict is also included but not listed here
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.10.8](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.10.8.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
...
sys-libs/libsystemd                                                                  | 253.3; 253.6; 253.11; 253.12; 254.3; 254.4; 254.5; (live)                                          | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/distributed           | 2023.9.3; 2023.10.0; 2023.10.1                    | Optional for arviz and spectral-cube
