...
dev-python/pydantic-settngs                                                          | 2.12.0                                                                                                                                            |
...
dev-python/azure-core              | 1.26.3; 1.38.0                                             | Required by new msrest
...
dev-python/ext4                    | 1.2.2                                                      | Optional for new ratarmount{,core} <- ipfsspec
...
dev-python/s3fs                    | 2025.10.0; 2025.12.0; 2026.1.0                             | Test dependency for zarr and astropy>=5.2
...
dev-python/textual                 | 7.5.0                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
