...
dev-python/poetry-dynamic-versioning                                                 | 1.10.0                                                                                                                                            | Dependency dunamai also included but not listed in the table
...
dev-python/arviz                   | 0.17.1; 0.23.4; 1.1.0                                      | Optional for corner.py. Dependency arviz-{base,stats,plots} are included but not listed in the table
