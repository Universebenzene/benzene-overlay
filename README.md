...
dev-python/flask-socketio          | 5.4.0                                                      | Optional for yt
...
dev-python/rasterio                | 1.3.8\_p2; 1.4.0                                           | Optional for photutils. Dependencies are not all listed in the table
