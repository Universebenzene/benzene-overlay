...
sys-libs/libsystemd                                                                  | 257.9; 257.10; 258.2; 258.3; 259\_rc2; 259\_rc3; (live)                                                                                           | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/s3fs                    | 2025.9.0; 2025.10.0; 2025.12.0; 2026.1.0                   | Test dependency for zarr and astropy>=5.2
...
dev-python/textual                 | 6.5.0                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/universal-pathlib       | 0.3.7                                                      | Test dependency for zarr
