...
[net-misc/oss-browser-bin](https://github.com/aliyun/oss-browser)                    | [1.18.0](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/oss-browser-bin/oss-browser-1.18.0.ebuild)                                | Encouraged by [AUR](https://aur.archlinux.org/packages/oss-browser-bin) （阿里云对象存储OSS图形化管理工具）
