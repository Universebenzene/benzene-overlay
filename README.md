...
dev-python/pydantic-settngs                                                          | 2.13.0                                                                                                                                            |
...
dev-python/arviz                   | 0.17.1; 0.23.4                                             | Optional for corner.py.
...
dev-python/textual                 | 8.0.0                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/universal-pathlib       | 0.3.9                                                      | Test dependency for zarr
...
dev-python/sphinxcontrib-globalsubs     | 0.1.2; 1.0.0                    |
