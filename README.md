...
[app-pda/i4tools](https://www.i4.cn/pro_pc.html)                                     | 3.09.002; [9.0.022](https://github.com/Universebenzene/benzene-overlay/blob/master/app-pda/i4tools/i4tools-9.0.022.ebuild)                                 | 爱思助手 <!--`net-nds/openldap-compat` is included in this overlay for fixing the `libldap_r-2.4.so.2` issue-->
...
dev-lang/gdl                                                                         | 1.0.4-r4; 1.0.6; 1.1.3                                                                                                                            | Allow `gdl` and the python module installed at the same time
...
dev-libs/liblzf                                                                      | 3.6                                                                                                                                               |
dev-python/aioftp                                                                    | 0.28.3                                                                                                                                            |
dev-python/bokeh                                                                     | 3.9.1                                                                                                                                             |
dev-python/corner                                                                    | 2.2.2; 2.3.0                                                                                                                                      |
dev-python/dask                                                                      | 2024.4.1; 2025.10.0; 2026.8.0                                                                                                                     | Dropped by official portage
dev-python/dask-image                                                                | 2026.5.0                                                                                                                                          |
dev-python/dropbox                                                                   | 12.2.0; 12.2.2                                                                                                                                    |
dev-python/exifread                                                                  | 3.5.1                                                                                                                                             |
dev-python/fs                                                                        | 2.4.16                                                                                                                                            | Dropped by official portage. Dependency for pyfatfs
dev-python/glfw                                                                      | 2.10.2                                                                                                                                            | Dependency for glue-vispy-viewer>=1.2.0
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.13.2\_p1; 0.13.8; 0.14.0\_p2; 0.14.8                                                                                        |
dev-python/hsluv                                                                     | 5.0.4                                                                                                                                             |
[dev-python/memray](https://bloomberg.github.io/memray)                              | [1.20.0](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-python/memray/memray-1.20.0.ebuild)                                            | **BINARY WHEEL VERSIONS** are used to avoid npm building
...
dev-python/py-cpuinfo:2                                                              | 10.1.1                                                                                                                                            |
dev-python/parfive                                                                   | 2.3.1                                                                                                                                             |
dev-python/poetry-dynamic-versioning                                                 | 1.10.0                                                                                                                                            |
dev-python/pycryptodomex                                                             | 3.23.0                                                                                                                                            |
dev-python/pyqt5                                                                     | 5.15.11{,-r1}                                                                                                                                     | Dropped by official portage. Add `webkit` USE flag to get **youdao-dict** in this overlay work. Dependency pyqt5-sip (also dropped by Gentoo) is included but not listed here
dev-python/pytest-benchmark                                                          | 4.0.0; 5.2.3; 5.3.0                                                                                                                               |
...
dev-python/yt                                                                        | 4.0.5; 4.1.4; 4.2.2; 4.3.0; 4.4.2                                                                                                                 | Full doc building needs huge amount of data, so cannot complete locally.
dev-python/zarr                                                                      | 2.18.4; 2.18.7; 3.3.0                                                                                                                             |
dev-qt/qt{help,sensors,webchannel}:5                                                 | 5.15.17; 5.15.18                                                                                                                                  | Optional for `dev-qt/qtwebkit`, dropped by official portage
...
[net-fs/ossfs](https://github.com/aliyun/ossfs)                                      | [1.91.12](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-1.91.12.ebuild); [2.0.6](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-2.0.6.ebuild) | 阿里云对象存储OSS Bucket挂载工具
...
[net-misc/baidunetdisk](https://pan.baidu.com/download)                              | 3.0.1; 4.3.0; [4.17.8](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidunetdisk/baidunetdisk-4.17.8.ebuild)                    | Converted from [AUR](https://aur.archlinux.org/packages/baidunetdisk-bin) and encouraged by [fixing](https://github.com/microcai/gentoo-zh/pull/3633) from @vowstar (Also in [gentoo-zh](https://github.com/microcai/gentoo-zh) overlay, while upgrade will be faster here) （百度网盘）
[net-misc/baidupcs-go](https://github.com/qjfoidnh/BaiduPCS-Go)                      | 3.6.2; 3.8.1; 3.9.5\_beta(template); [4.0.2](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-4.0.2.ebuild); [(live)](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-9999.ebuild) | Also in [gentoo-zh](https://github.com/microcai/gentoo-zh) overlay, while upgrade will be faster here. **Proxy may needed if you use the `9999` version**, as the [proxy.golang.org](https://proxy.golang.org) is banned in some regions
...
[net-misc/todesk](https://www.todesk.com/download.html)                              | 4.1.0-r4; 4.3.1.0; 4.7.2.0; [4.8.6.2](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/todesk/todesk-4.8.6.2.ebuild)                | Encouraged by [AUR](https://aur.archlinux.org/packages?O=0&SeB=nd&K=todesk-&outdated=&SB=n&SO=a&PP=50&submit=Go) （ToDesk远程控制）
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.7.5](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.7.5.ebuild); [2.4.25](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.4.25.ebuild); [2.5.7](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.5.7.ebuild) | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
[sci-astronomy/astrometry](https://astrometry.net)                                   | 0.78; 0.80; 0.85; [0.98](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/astrometry/astrometry-0.98.ebuild)                   | Add USE for switching the netpbm support
...
[sci-astronomy/topcat](http://www.star.bris.ac.uk/~mbt/topcat)                       | 4.8; 4.9.1; [4.10.7](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/topcat/topcat-4.10.7.ebuild); [4.10.8](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/topcat/topcat-4.10.8.ebuild) |
[sys-block/diskus](https://github.com/sharkdp/diskus)                                | [0.9.0](https://github.com/Universebenzene/benzene-overlay/blob/master/sys-block/diskus/diskus-0.9.0.ebuild); (live)                                       |
sys-libs/libsystemd                                                                  | 259.4-r2; 260.1-r2; 260.2-r1; 260.4; 261-r1; 261.1; 261.2; 261.3; 262; 262\_rc1; (live)                                                           | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/aiobotocore             | 3.3.0                                                      | Pulled in by s3fs
dev-python/aiohttp-retry           | 2.9.1                                                      | Optional for new ratarmount{,core} <- ipfsspec
dev-python/arviz                   | 0.17.1; 0.23.4; 1.3.0                                      | Optional for corner.py. Dependency arviz-{base,stats,plots} are included but not listed in the table
...
dev-python/bidict                  | 0.22.0; 0.24.1                                             | Optional for yt
...
dev-python/distributed             | 2024.4.1; 2025.10.0; 2026.8.0                              | Optional for arviz and spectral-cube
...
dev-python/ext4                    | 1.2.4; 1.4.1                                               | Optional for new ratarmount{,core} <- ipfsspec
...
dev-python/firefly                 | 3.6.0                                                      | Optional for new yt
dev-python/flask-socketio          | 5.6.1                                                      | Optional for yt
dev-python/fusepy                  | 3.0.1                                                      | Optional for old ratarmount
dev-python/google-crc32c           | 1.9.0                                                      | Required by new numcodecs, zarr
...
dev-python/markdownify             | 1.2.3                                                      | Required by mkdocs-llmstxt
...
dev-python/optimagic               | 0.5.4                                                      | Optional for new sherpa
...
dev-python/py7zr                   | 1.0.0; 1.1.3                                               | Optional for new ratarmount{,core}
dev-python/pybaum                  | 0.1.3                                                      | Optional for new sherpa <- optimagic
dev-python/pybcj                   | 1.0.8                                                      | Optional for new ratarmount{,core} <- py7zr
...
dev-python/python-socketio         | 5.9.0; 5.17.0                                              | Optional for yt
...
dev-python/rasterio                | 1.3.8\_p2; 1.5.1                                           | Optional for photutils. Dependencies are not all listed in the table
dev-python/ratarmount              | 0.8.1; 0.14.2; 0.15.2; 1.0.0; 1.3.0                        | Optional for yt. Dependency ratarmountcore is also included in this overlay but not listed in the table
dev-python/s3fs                    | 2026.7.0                                                   | Test dependency for zarr and astropy>=5.2
dev-python/siosocks                | 0.3.0                                                      | Optional for aioftp
dev-python/slicerator              | 1.1.0                                                      | Required by pims <- dask-image <- new reproject
dev-python/smbprotocol             | 1.17.0                                                     | Optional for new ratarmount{,core}
...
dev-python/sshfs                   | 2026.8.0                                                   | Optional for new ratarmount{,core}. <!--For running test, you need to forcely unmask paramiko[server], e.g. `echo "dev-python/paramiko -server" >> /etc/portage/profile/package.use.mask"`-->
dev-python/stone                   | 3.3.9; 3.5.5                                               | Required by python dropbox
...
Package name | Available version | Additional information
------------ | :---------------: | ----------------------
dev-python/sphinx                        | 5.1.1; 7.1.2; 8.2.3-r2          | 5 for old myst-parser and myst-nb; 7.1 for glue-qt doc <!-- sphinx>=6 <- copybutton <-doc- sphinx-thebe -doc-> myst-nb -> myst-parser(oldver needs sphinx<6) -->
...
dev-python/sphinx-book-theme             | 1.0.1; 1.4.0                    | `network-sandbox` FEATURE will be disabled if you enable `doc` flag for newest version.
dev-python/sphinx-changelog              | 1.6.0                           |
dev-python/sphinx-click                  | 6.0.0; 6.2.0                    |
dev-python/sphinx-codeautolink           | 0.19.0                          |
...
dev-python/mkdocs-literate-nav          | 0.6.3           | mkdocstrings related (should be test depend)
dev-python/mkdocs-llmstxt               | 0.5.0           | Doc/test dependency for mkdocs-coverage
dev-python/mkdocs-section-index         | 0.3.11          | mkdocstrings related (should be test depend)
