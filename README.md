...
[app-pda/i4tools](https://www.i4.cn/pro_pc.html)                                     | [3.07.001](https://github.com/Universebenzene/benzene-overlay/blob/master/app-pda/i4tools/i4tools-3.07.001.ebuild)                                         | 爱思助手 <!--`net-nds/openldap-compat` is included in this overlay for fixing the `libldap_r-2.4.so.2` issue-->
...
[app-text/gimagereader](https://github.com/manisandro/gImageReader)                  | [3.4.2](https://github.com/Universebenzene/benzene-overlay/blob/master/app-text/gimagereader/gimagereader-3.4.2.ebuild)                                    | Dropped by [salfter](https://gitlab.com/salfter/portage/-/commit/f7d8d5dd1c0a9b89a49c97369a1585cfdb0e1b6a) overlay
...
app-text/qtspell                                                                     | 1.0.1                                                                                                                                                      | Dependency for gimagereader[qt5,qt6]
...
dev-python/zarr                                                                      | 2.18.4; 2.18.7; 3.1.1                                                                                                                             |
...
[net-fs/ossfs](https://github.com/aliyun/ossfs)                                      | [1.91.7](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-1.91.7.ebuild)                                                  | 阿里云对象存储OSS Bucket挂载工具
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.6.7](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.6.7.ebuild)                       | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
[sci-astronomy/topcat](http://www.star.bris.ac.uk/~mbt/topcat)                       | 4.8; 4.9.1; [4.10.4](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/topcat/topcat-4.10.4.ebuild)                             |
...
sys-libs/libsystemd                                                                  | 256.10; 256.12; 256.13; 256.16; 256.17; 257.3; 257.5; 257.6; 257.7; 257.8-r1; (live)                                                              | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/rapidgzip               | 0.14.5                                                     | Optional for new ratarmount{,core}
...
dev-python/ratarmount              | 0.8.1; 0.14.2; 0.15.2; 1.0.0; 1.1.2                        | Optional for yt. Dependency ratarmountcore is also included in this overlay but not listed in the table
...
dev-python/textual                 | 5.3.0                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/sphinx-sitemap               | 2.6.0; 2.7.2                    |
