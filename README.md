...
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.12.9\_p2; 0.13.2\_p1; 0.13.5                                                                    |
dev-python/hsluv                                                                     | 5.0.4                                                                                                                 |
[dev-python/memray](https://bloomberg.github.io/memray)                              | 1.10.0; [1.13.4](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-python/memray/memray-1.13.4.ebuild)                                    | **BINARY WHEEL VERSIONS** are used to avoid npm building
...
dev-python/PyQt5                                                                     | 5.15.10-r1; 5.15.11                                                                                                   | Add `webkit` USE flag (dropped by official portage) to get **youdao-dict** in this overlay work
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.12.9](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.12.9.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
...
dev-python/textual                 | 0.74.0                                                     | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
