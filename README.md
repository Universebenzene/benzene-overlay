...
dev-python/textual                 | 0.57.0                                                     | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/sphinx-mdinclude             | 0.5.4                 |
