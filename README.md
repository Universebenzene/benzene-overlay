...
[dev-util/micromamba{,-bin}](https://mamba.readthedocs.io)                           | [1.5.3](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-util/micromamba/micromamba-1.5.3.ebuild)                                         | [mva](https://github.com/msva/mva-overlay) (for depend `dev-cpp/tl-expected`) overlay is needed for building the source version.
...
[net-im/wemeet](https://source.meeting.qq.com/download-center.html)                  | 2.8.0.3; 3.10.0.401; 3.15.1.402[arm64 only]; [3.19.1.400](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/wemeet/wemeet-3.19.0.400.ebuild)[amd64 only] | Encouraged by [AUR](https://aur.archlinux.org/packages/wemeet-bin) （腾讯会议）
...
dev-python/distributed           | 2023.11.0; 2023.12.0                              | Optional for arviz and spectral-cube
...
dev-python/s3fs                  | 2023.10.0; 2023.12.0; 2023.12.1; 2023.12.2        | Test dependency for zarr and astropy>=5.2
