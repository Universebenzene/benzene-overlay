...
[app-pda/i4tools](https://www.i4.cn/pro_pc.html)                                     | [3.09.002](https://github.com/Universebenzene/benzene-overlay/blob/master/app-pda/i4tools/i4tools-3.09.002.ebuild)                                         | 爱思助手 <!--`net-nds/openldap-compat` is included in this overlay for fixing the `libldap_r-2.4.so.2` issue-->
...
dev-python/zarr                                                                      | 2.18.4; 2.18.7; 3.1.6                                                                                                                             |
...
[net-fs/ossfs](https://github.com/aliyun/ossfs)                                      | [1.91.9](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-1.91.9.ebuild); [2.0.6](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-2.0.6.ebuild) | 阿里云对象存储OSS Bucket挂载工具
...
dev-python/azure-core              | 1.26.3; 1.39.0                                             | Required by new msrest
...
dev-python/s3fs                    | 2026.2.0; 2026.3.0                                         | Test dependency for zarr and astropy>=5.2
...
dev-python/sphinx-codeautolink          | 0.18.0                          |
