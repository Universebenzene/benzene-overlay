...
dev-python/yt                                                                        | 4.0.5; 4.1.4                                                                     | Full doc building needs huge amount of data, so cannot complete locally.
...
[net-im/wemeet](https://source.meeting.qq.com/download-center.html)                  | 2.8.0.3; 3.10.0.401; [3.15.0.401](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/wemeet/wemeet-3.15.0.401.ebuild)                   | Encouraged by [AUR](https://aur.archlinux.org/packages/wemeet-bin) （腾讯会议）
...
dev-python/jupytext              | 1.14.6           | Build with wheel source to include Jupyter Lab Extenstion
