...
[app-pda/i4tools](https://www.i4.cn/pro_pc.html)                                     | [3.06.007](https://github.com/Universebenzene/benzene-overlay/blob/master/app-pda/i4tools/i4tools-3.06.006.ebuild)                                         | 爱思助手 <!--`net-nds/openldap-compat` is included in this overlay for fixing the `libldap_r-2.4.so.2` issue-->
...
dev-python/dask                                                                      | 2024.4.1; 2024.12.1                                                                                                   | Dropped by official portage
dev-python/dropbox                                                                   | 12.0.2                                                                                                                |
dev-python/exifread                                                                  | 3.0.0                                                                                                                 |
dev-python/glfw                                                                      | 2.8.0                                                                                                                 | Dependency for glue-vispy-viewer>=1.2.0
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.12.9\_p2; 0.13.2\_p1; 0.13.7                                                                    |
dev-python/hsluv                                                                     | 5.0.4                                                                                                                 |
[dev-python/memray](https://bloomberg.github.io/memray)                              | 1.10.0; [1.15.0](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-python/memray/memray-1.15.0.ebuild)                                    | **BINARY WHEEL VERSIONS** are used to avoid npm building
...
[net-fs/ossfs](https://github.com/aliyun/ossfs)                                      | [1.91.5](https://github.com/Universebenzene/benzene-overlay/blob/master/net-fs/ossfs/ossfs-1.91.5.ebuild)                                                  | 阿里云对象存储OSS Bucket挂载工具
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.12.23](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.12.23.ebuild)             | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
...
[net-misc/baidupcs-go](https://github.com/qjfoidnh/BaiduPCS-Go)                      | 3.6.2; 3.8.1; 3.9.5\_beta(template); [3.9.7](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-3.9.7.ebuild); [(live)](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-9999.ebuild) | Also in [gentoo-zh](https://github.com/microcai/gentoo-zh) overlay, while upgrade will be faster here. **Proxy may needed if you use the `9999` version**, as the [proxy.golang.org](https://proxy.golang.org) is banned in some regions
net-misc/baidupcs-go-bin                                                             | 3.6.2; 3.9.5\_beta(template); 3.9.7 |
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.6.3](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.6.3.ebuild)                       | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
[sci-astronomy/topcat](http://www.star.bris.ac.uk/~mbt/topcat)                       | 4.8; 4.9.1; [4.10.2](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/topcat/topcat-4.10.2.ebuild)                             |
...
sys-libs/libsystemd                                                                  | 254.17; 254.21 254.22; 254.23;; 255.11; 255.15; 255.16; 255.17; 256.7; 256.9; 256.10; 256.11; 257.1; 257.2; (live)    | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/sphinx-codeautolink          | 0.16.1                          |
...
dev-python/sphinx-reredirects           | 0.1.5                           |
