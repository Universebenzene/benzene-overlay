...
dev-lang/gdl                                                                         | 1.0.0\_rc3-r3; 1.0.1-rc3                                                                | Allow `gdl` and the python module installed at the same time
...
dev-python/vispy                                                                     | 0.13.0; 0.14.0                                                                          | Doc building may have problems with sandbox permission
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.10.2](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.10.2.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support. Might not work due to [a bug in OICQ](https://github.com/takayama-lily/oicq/issues/408)
[net-im/wemeet](https://source.meeting.qq.com/download-center.html)                  | 2.8.0.3; 3.10.0.401; [3.15.1.401](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/wemeet/wemeet-3.15.1.401.ebuild)[amd64 only]; 3.15.1.402[arm64 only] | Encouraged by [AUR](https://aur.archlinux.org/packages/wemeet-bin) （腾讯会议）
...
[net-misc/baidupcs-go](https://github.com/qjfoidnh/BaiduPCS-Go)                      | 3.6.2; 3.8.1; [3.9.4](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-3.9.4.ebuild); 3.9.5\_beta(unstable); [(live)](https://github.com/Universebenzene/benzene-overlay/blob/master/net-misc/baidupcs-go/baidupcs-go-9999.ebuild) | Also in [gentoo-zh](https://github.com/microcai/gentoo-zh) overlay, while upgrade will be faster here. **Proxy may needed if you use the `9999` version**, as the [proxy.golang.org](https://proxy.golang.org) is banned in some regions
net-misc/baidupcs-go-bin                                                             | 3.6.2; 3.9.4; 3.9.5\_beta(unstable) |
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.4](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.4.ebuild)                           | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
sys-libs/libsystemd                                                                  | 253.3; 253.4; 253.5; 253.5-r1; 253.6; 253.7; 253.8; 253.10; 254.1-r2; 254.3; (live)     | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/distributed           | 2023.8.0; 2023.8.1; 2023.9.0; 2023.9.1            | Optional for arviz and spectral-cube
...
dev-python/s3fs                  | 2023.6.0; 2023.6.0                                | Test dependency for zarr and astropy>=5.2
...
dev-python/cmyt                  | 1.3.1                                             | Pulled in by yt
...
dev-python/jupytext                     | 1.15.1              | Build with wheel source to include Jupyter Lab Extenstion
...
dev-python/sphinx-asdf                  | 0.1.3; 0.1.4; 0.2.1 |
