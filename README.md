...
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.12.9\_p2; 0.13.2\_p1; 0.13.8                                                                                                |
...
dev-python/pydantic-settngs                                                          | 2.8.1                                                                                                                                             |
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.6.6](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.6.6.ebuild)                       | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
sys-libs/libsystemd                                                                  | 254.17; 254.21; 254.22; 254.23; 254.24; 255.11; 255.15; 255.16; 255.17; 255.18; 256.7; 256.9; 256.10; 256.11; 256.12; 257.1; 257.2;; 257.3 (live) | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/aiobotocore             | 2.20.0                                                     | Pulled in by s3fs
...
dev-python/s3fs                    | 2025.2.0                                                   | Test dependency for zarr and astropy>=5.2
...
dev-python/textual                 | 2.1.2                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/sphinx-codeautolink          | 0.17.3                          |
