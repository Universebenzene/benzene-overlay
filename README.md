...
dev-python/pydantic-settngs                                                          | 2.13.1                                                                                                                                            |
dev-python/pytest-benchmark                                                          | 4.0.0; 5.2.2                                                                                                                                      |
...
dev-python/ext4                    | 1.2.4; 1.3.1                                               | Optional for new ratarmount{,core} <- ipfsspec
...
dev-python/ratarmount              | 0.8.1; 0.14.2; 0.15.2; 1.0.0; 1.2.2                        | Optional for yt. Dependency ratarmountcore is also included in this overlay but not listed in the table
...
dev-python/textual                 | 8.2.3                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
