...
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.12.9\_p2; 0.13.2\_p1; 0.13.3                                                                    |
dev-python/hsluv                                                                     | 5.0.4                                                                                                                 |
[dev-python/memray](https://bloomberg.github.io/memray)                              | 1.10.0; [1.13.2](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-python/memray/memray-1.13.2.ebuild)                                    | **BINARY WHEEL VERSIONS** are used to avoid npm building
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.5.6](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.5.6.ebuild)                       | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
sys-libs/libsystemd                                                                  | 254.8-r1; 254.10; 254.12; 254.13; 255.3-r1; 255.4; 255.6; 255.7; 256.1; (live)                                        | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
