...
sys-libs/libsystemd                                                                  | 254.17; 254.21; 255.11; 255.15; 256.7; 256.9; (live)                                                                  | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/jupytext                     | 1.16.5                          | Build with wheel source to include Jupyter Lab Extenstion
