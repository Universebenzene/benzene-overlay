...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; [2.9.13](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.9.13.ebuild)                         | Previously called Electron QQ. A branch of previous deleted repo, with limited support. Might not work due to [a bug in OICQ](https://github.com/takayama-lily/oicq/issues/408)
...
dev-python/distributed           | 2023.4.0; 2023.4.1; 2023.5.0; 2023.5.1            | Optional for arviz and spectral-cube
...
dev-python/rasterio              | 1.3.7                                             | Optional for photutils. Dependencies are not all listed in the table
...
dev-python/mkdocstrings-crystal       | 0.3.5           |
