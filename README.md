...
[app-text/ydcv-rs](https://github.com/farseerfc/ydcv-rs)                             | [0.6.2](https://github.com/Universebenzene/benzene-overlay/blob/master/app-text/ydcv-rs/ydcv-rs-0.6.2.ebuild); (live)                                      |
...
[dev-util/micromamba{,-bin}](https://mamba.readthedocs.io)                           | [1.5.1](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-util/micromamba/micromamba-1.5.1.ebuild)                                         | [mva](https://github.com/msva/mva-overlay) (for depend `dev-cpp/tl-expected`) overlay is needed for building the source version.
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.10.10](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.10.10.ebuild)             | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
[net-im/wemeet](https://source.meeting.qq.com/download-center.html)                  | 2.8.0.3; 3.10.0.401; 3.15.1.402[arm64 only]; [3.15.1.403](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/wemeet/wemeet-3.15.1.403.ebuild)[amd64 only] | Encouraged by [AUR](https://aur.archlinux.org/packages/wemeet-bin) （腾讯会议）
...
[net-proxy/v2raya-bin](https://v2raya.org)                                           | 1.5.1698.1; [2.2.4.3](https://github.com/Universebenzene/benzene-overlay/blob/master/net-proxy/v2raya-bin/v2raya-bin-2.2.4.3.ebuild)                       | Converted from [AUR](https://aur.archlinux.org/packages/v2raya-bin). Needs other overlays like [gentoo-zh](https://github.com/microcai/gentoo-zh). From 2.2.1 only armv7 source is used for arm KEYWORD. If you need armv6 one, try editing the `SRC_URI` yourself.
...
[sci-astronomy/topcat](http://www.star.bris.ac.uk/~mbt/topcat)                       | 4.8; [4.9](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/topcat/topcat-4.9.ebuild)                                          |
...
sys-libs/libsystemd                                                                  | 253.3; 253.6; 253.11; 253.12; 253.13; 254.3; 254.4; 254.5-r1; 254.6; (live)                        | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/distributed           | 2023.9.3; 2023.10.0; 2023.10.1; 2023.11.0         | Optional for arviz and spectral-cube
...
dev-python/rapidgzip             | 0.10.3                                            | Optional for new ratarmount{,core}
...
dev-python/s3fs                  | 2023.9.2; 2023.10.0                               | Test dependency for zarr and astropy>=5.2
...
dev-python/sphinx-thebe                 | 0.2.1; 0.3.0        |
...
dev-python/sphinxext-opengraph          | 0.9.0               |
