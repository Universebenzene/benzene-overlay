...
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.12.9\_p2; 0.13.1                                                                                |
dev-python/hsluv                                                                     | 5.0.4                                                                                                                 |
[dev-python/memray](https://bloomberg.github.io/memray)                              | 1.10.0; [1.12.0](https://github.com/Universebenzene/benzene-overlay/blob/master/dev-python/memray/memray-1.12.0.ebuild)                                    | **BINARY WHEEL VERSIONS** are used to avoid npm building
dev-python/nose                                                                      | 1.3.7\_p20221026                                                                                                      | Dropped by official portage
...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.11.6](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.11.6.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
...
[sci-astronomy/astrometry](https://astrometry.net)                                   | 0.78; 0.80; 0.85; [0.94](https://github.com/Universebenzene/benzene-overlay/blob/master/sci-astronomy/astrometry/astrometry-0.94.ebuild)                   | Add USE for switching the netpbm support
...
sys-libs/libsystemd                                                                  | 254.8-r1; 254.9-r1; 254.10; 254.11; 255.3-r1; 255.4; 255.5; (live)                                                    | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/rapidgzip               | 0.13.2                                                     | Optional for new ratarmount{,core}
...
dev-python/textual                 | 0.58.0                                                     | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
...
dev-python/sunpy-sphinx-theme           | 1.2.42; 2.0.2; 2.0.10 |
