...
dev-python/PyQt5                                                                     | 5.15.6                                                        | Add `webkit` USE flag (dropped by official portage) to get **youdao-dict** in this overlay work
...
[net-im/wemeet](https://source.meeting.qq.com/download-center.html)                  | 2.8.0.3; 2.8.0.4 (arm64); 3.9.0.1-r1; [3.10.0.401](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/wemeet/wemeet-3.10.0.401.ebuild)  | Encouraged by [AUR](https://aur.archlinux.org/packages/wemeet-bin) （腾讯会议）
