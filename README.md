...
dev-python/glymur                                                                    | 0.12.0; 0.12.9\_p1; 0.13.2\_p1; 0.13.8; 0.14.0\_p2; 0.14.7                                                                                        |
...
dev-python/zarr                                                                      | 2.18.4; 2.18.7; 3.2.0                                                                                                                             |
...
dev-python/azure-core              | 1.26.3; 1.40.0                                             | Required by new msrest
...
dev-python/ext4                    | 1.2.4; 1.3.2                                               | Optional for new ratarmount{,core} <- ipfsspec
...
dev-python/ratarmount              | 0.8.1; 0.14.2; 0.15.2; 1.0.0; 1.2.3                        | Optional for yt. Dependency ratarmountcore is also included in this overlay but not listed in the table
...
dev-python/textual                 | 8.2.4                                                      | Pulled in by memray>=1.11. Dependency tree-sitter-languages is included but not listed in the table
