...
[net-im/icalingua++-bin](https://github.com/Icalingua-plus-plus/Icalingua-plus-plus) | 2.7.7; 2.9.13; [2.10.3](https://github.com/Universebenzene/benzene-overlay/blob/master/net-im/icalingua++-bin/icalingua++-bin-2.10.3.ebuild)               | Previously called Electron QQ. A branch of previous deleted repo, with limited support.
...
dev-python/distributed           | 2023.8.0; 2023.8.1; 2023.9.0; 2023.9.1; 2023.9.2  | Optional for arviz and spectral-cube
...
dev-python/s3fs                  | 2023.6.0; 2023.9.1                                | Test dependency for zarr and astropy>=5.2
