...
dev-python/aiobotocore             | 2.26.0                                                     | Pulled in by s3fs
...
dev-python/azure-core              | 1.26.3; 1.36.0                                             | Required by new msrest
...
dev-python/python-pkcs11           | 0.9.2                                                      | Test and optional dependency for asyncssh. Recover from [GURU](https://gitweb.gentoo.org/repo/proj/guru.git/commit/?id=a6b3f15b1a76a2b066f9ff763fab5588bab902c6)
dev-python/python-socketio         | 5.9.0; 5.15.0                                              | Optional for yt
...
dev-python/s3fs                    | 2025.9.0; 2025.10.0; 2025.12.0                             | Test dependency for zarr and astropy>=5.2
...
dev-python/sshfs                   | 2025.10.0                                                  | Optional for new ratarmount{,core}. <!--For running test, you need to forcely unmask paramiko[server], e.g. `echo "dev-python/paramiko -server" >> /etc/portage/profile/package.use.mask"`-->
