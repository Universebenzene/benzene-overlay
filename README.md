...
app-i18n/mozc                                                                        | 2.28.5029.102-r5                                                                                                                                  | Include fcitx4 support that dropped by official portage
...
dev-lang/gdl                                                                         | 1.0.0\_rc3-r3; 1.0.1-r3; 1.0.4-r2                                                                                                                 | Allow `gdl` and the python module installed at the same time
...
dev-python/zarr                                                                      | 2.18.4; 2.18.7; 3.0.8                                                                                                                             |
dev-qt/qt{sensors,webchannel}:5                                                      | 5.15.16; 5.15.17                                                                                                                                  | Optional for `dev-qt/qtwebkit`, dropped by official portage
...
sys-libs/libsystemd                                                                  | 256.10; 256.12; 256.13; 256.16; 257.3; 257.5; 257.6; (live)                                                                                       | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/eventlet                | 0.33.3; 0.40.0                                             | Dropped by official portage. Required by firefly{,-viz}
...
dev-python/s3fs                    | 2025.3.2; 2025.5.0; 2025.5.1                               | Test dependency for zarr and astropy>=5.2
