...
dev-python/dask                                                                      | 2024.4.1; 2025.3.0                                                                                                                                | Dropped by official portage
...
dev-python/poetry-dynamic-versioning                                                 | 1.8.0                                                                                                                                             | Dependency dunamai also included but not listed in the table
...
sys-libs/libsystemd                                                                  | 254.22; 254.24; 255.16; 255.18; 256.10; 256.12; 257.3 (live)                                                                                      | A standalone package to provide `libsystemd.so` for packages depend on the lib on non-systemd system. [Still on trial](https://github.com/Universebenzene/benzene-overlay/tree/master/sys-libs/libsystemd). **IF YOU HAVE ANY IDEA TO IMPROVE THIS PACKAGE JUST BRING ISSUES OR PULL REQUESTS.**
...
dev-python/distributed             | 2024.4.1; 2025.3.0                                         | Optional for arviz and spectral-cube
...
dev-python/sphinx-reredirects           | 0.1.6                           |
...
dev-python/mkdocstrings-python-legacy   | 0.2.4; 0.2.6    |
