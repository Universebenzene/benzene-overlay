...
src_install() {
	...
	newinitd "${FILESDIR}"/${MY_PN}-user.initd-r1 ${MY_PN}-user
	newconfd "${FILESDIR}"/${MY_PN}.confd-r2 ${MY_PN}
	newconfd "${FILESDIR}"/${MY_PN}-user.confd-r1 ${MY_PN}-user
	systemd_newunit "${FILESDIR}"/${MY_PN}-r1.service ${MY_PN}.service
	systemd_newunit "${FILESDIR}"/${MY_PN}_at-r1.service ${MY_PN}@.service
