...
if [[ ${PV} == *9999* ]]; then
	...
	EGO_SUM=(
		...
		"github.com/cloudflare/cloudflare-go v0.26.0/go.mod"
		...
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v0.0.0-20211016031441-3a50d1bea71d/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v0.0.0-20211019113435-2b02ec955a73/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v0.0.0-20211019113859-3595f87fd1c7/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v0.0.0-20211020052956-c845ae4b5d3c/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v0.1.15/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v1.1.10"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/BitterJohn v1.1.10/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211018083001-b705b698c27c/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211019113726-5f4cc4dfa31e/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211020023854-3afe293c54f8/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211028080841-aede37595f6b/go.mod"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211106045307-739b77368531"
		"github.com/e14914c0-6759-480d-be89-66b7b7676451/SweetLisa v0.0.0-20211106045307-739b77368531/go.mod"
		"github.com/ebfe/rc2 v0.0.0-20131011165748-24b9757f5521"
		"github.com/ebfe/rc2 v0.0.0-20131011165748-24b9757f5521/go.mod"
		"github.com/eknkc/basex v1.0.1"
		"github.com/eknkc/basex v1.0.1/go.mod"
		...
		"github.com/mzz2017/cobra v0.0.0-20211205075040-2b7f80d9e0b4"
		"github.com/mzz2017/cobra v0.0.0-20211205075040-2b7f80d9e0b4/go.mod"
		"github.com/mzz2017/disk-bloom v1.0.0/go.mod"
		"github.com/mzz2017/disk-bloom v1.0.1"
		"github.com/mzz2017/disk-bloom v1.0.1/go.mod"
		"github.com/mzz2017/pflag v0.0.0-20211204030847-74e9419ee6b3"
		"github.com/mzz2017/pflag v0.0.0-20211204030847-74e9419ee6b3/go.mod"
		...
		"gopkg.in/tucnak/telebot.v2 v2.4.0/go.mod"
...
src_compile() {
	...
	go build -v -x -ldflags="-X github.com/mzz2017/gg/cmd.Version=${PV} -linkmode=external" -o . ./... || die
}
